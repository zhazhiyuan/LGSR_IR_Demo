...
c2                  =      1;    
 ...
 if  Subrate <=0.1
     ...
     mu  =  0.002;       alpha =  0.0007;     beta = 0.00005;
     


 [Ori, Subrate, alpha, beta, mu, c1, c2, jj, PSNR_Final,FSIM_Final,SSIM_Final,Time_s, Err_or]= LGSR_CS_Test(filename, IterNum, Subrate, alpha, beta, mu, c1, c2);
 
 m_1= m_1+1;
 
 s=strcat('A',num2str(m_1));
 
 All_data_Results_1{m_1}={Ori, Subrate,  mu, alpha,  beta,  c1, c2, jj, PSNR_Final,FSIM_Final,SSIM_Final,Time_s, Err_or};
 
 xlswrite('LGSR_CS_0.1_Test_Final.xls', All_data_Results_1{m_1},'sheet1',s);
...
elseif  Subrate <=0.2
     ...
     mu  =  0.001;       alpha =  0.0006;     beta = 0.0003;
...
[Ori, Subrate, alpha, beta, mu, c1, c2, jj, PSNR_Final,FSIM_Final,SSIM_Final,Time_s, Err_or]= LGSR_CS_Test(filename, IterNum, Subrate, alpha, beta, mu, c1, c2);
 ...
 All_data_Results_4{m_4}={Ori, Subrate,  mu, alpha,  beta,  c1, c2, jj, PSNR_Final,FSIM_Final,SSIM_Final,Time_s, Err_or};
 
 xlswrite('LGSR_CS_0.2_Test_Final.xls', All_data_Results_4{m_4},'sheet1',s);
 ...
 elseif  Subrate <=0.3
     ...
     mu  =  0.001;       alpha =  0.0009;     beta = 0.0001;
...
[Ori, Subrate, alpha, beta, mu, c1, c2, jj, PSNR_Final,FSIM_Final,SSIM_Final,Time_s, Err_or]= LGSR_CS_Test(filename, IterNum, Subrate, alpha, beta, mu, c1, c2);
 ...
 All_data_Results_7{m_7}={Ori, Subrate,  mu, alpha,  beta,  c1, c2, jj, PSNR_Final,FSIM_Final,SSIM_Final,Time_s, Err_or};
 
 xlswrite('LGSR_CS_0.3_Test_Final.xls', All_data_Results_7{m_7},'sheet1',s);
...
[Ori, Subrate, alpha, beta, mu, c1, c2, jj, PSNR_Final,FSIM_Final,SSIM_Final,Time_s, Err_or]= LGSR_CS_Test(filename, IterNum, Subrate, alpha, beta, mu, c1, c2);
 ...
 All_data_Results_10{ m_10}={Ori, Subrate,  mu, alpha,  beta,  c1, c2, jj, PSNR_Final,FSIM_Final,SSIM_Final,Time_s, Err_or};
 
 xlswrite('LGSR_CS_0.4_Test_Final.xls', All_data_Results_10{ m_10},'sheet1',s);
 ...
 elseif Subrate <=0.5
     ...
     mu  =  0.001;       alpha =  0.0009;     beta = 0.0003;
...
[Ori, Subrate, alpha, beta, mu, c1, c2, jj, PSNR_Final,FSIM_Final,SSIM_Final,Time_s, Err_or]= LGSR_CS_Test(filename, IterNum, Subrate, alpha, beta, mu, c1, c2);
 ...
 All_data_Results_13{ m_13}={Ori, Subrate,  mu, alpha,  beta,  c1, c2, jj, PSNR_Final,FSIM_Final,SSIM_Final,Time_s, Err_or};
 
 xlswrite('LGSR_CS_0.5_Test_Final.xls', All_data_Results_13{ m_13},'sheet1',s);
...
[Ori, Subrate, alpha, beta, mu, c1, c2, jj, PSNR_Final,FSIM_Final,SSIM_Final,Time_s, Err_or]= LGSR_CS_Test(filename, IterNum, Subrate, alpha, beta, mu, c1, c2);
 ...
 xlswrite('LGSR_CS_text_miss_Test_Final_3.xls', All_data_Results_16{ m_16},'sheet1',s);        
         
 save LGSR_CS_text_miss_Test_Final  All_data_Results_16 
