...
function [Reconstructed_image, PSN_Result,FSIM_Result,SSIM_Result, j, Err_or,All_PSNR] = LGSR_CS_Main(Y, Opts)
...
for j = 1:IterNum
    ...
    Inter_out                        =                                  LGSR_Core  (r, Opts);  
   
   
   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%ADMM%%%%%%%%%%%%%%%%%%%%%%
   
       L                             =                                  (Opts.beta*r-Opts.beta*C + Opts.mu* Inter_out)/ (mu+ Opts.beta + eps);  
